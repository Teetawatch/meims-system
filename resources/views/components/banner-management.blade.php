                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="w-32 h-16 rounded-lg overflow-hidden border border-slate-200">
                                        <img src="{{ asset('images/banners/' . $banner->image_path) }}" class="w-full h-full object-cover" alt="{{ $banner->title }}">
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                    ...
                    <div>
                        ...
                        <div class="relative w-full h-48 bg-slate-100 rounded-xl overflow-hidden border-2 border-dashed border-slate-200 group">
                            ...
                            @elseif($existingImage)
                                <img src="{{ asset('images/banners/' . $existingImage) }}" class="w-full h-full object-cover">
                            @else

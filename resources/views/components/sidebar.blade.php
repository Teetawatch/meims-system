        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('students.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('students.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('students.*') ? '' : 'group-hover:text-blue-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('teachers.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('teachers.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('teachers.*') ? '' : 'group-hover:text-blue-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                    <span class="font-bold text-sm">ข้อมูลคณาจารย์</span>
                </a>

                <a href="{{ route('courses.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('courses.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('courses.*') ? '' : 'group-hover:text-pink-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('subjects.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('subjects.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('subjects.*') ? '' : 'group-hover:text-indigo-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('grades.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('grades.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('grades.*') ? '' : 'group-hover:text-emerald-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('transcripts.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('transcripts.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('transcripts.*') ? '' : 'group-hover:text-indigo-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('timetables.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('timetables.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('timetables.*') ? '' : 'group-hover:text-pink-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('documents.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('documents.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('documents.*') ? '' : 'group-hover:text-amber-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                        </path>
                ...
                <a href="{{ route('surveys.index') }}"
                    class="flex items-center px-4 py-3 rounded-xl group transition-all {{ request()->routeIs('surveys.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('surveys.*') ? '' : 'group-hover:text-amber-500 transition-colors' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

<div>
    ...
    <div class="min-h-screen bg-slate-50 relative font-sans overflow-hidden"
        ...
        <div class="fixed inset-0 w-full h-full pointer-events-none z-0">
            <div
                class="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-400/20 rounded-full blur-[100px] animate-pulse">
            </div>
            <div
                class="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-purple-400/20 rounded-full blur-[100px] animate-pulse animation-delay-2000">
            </div>
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 py-8 md:py-12 pb-32">
            ...
            <div class="text-center mb-10">
                <div
                    class="inline-flex p-3 bg-white rounded-2xl shadow-lg shadow-blue-500/10 mb-4 transform -rotate-3 hover:rotate-0 transition-transform duration-300">
                    ...
                    <div class="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-4 mb-10">
                        @foreach(range(1, $totalSteps) as $step)
                            @php
                                ...
                                $icons = [
                                    1 => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', // Account
                                    2 => 'M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14', // Personal
                                    3 => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', // Address
                                    4 => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', // Family
                                    5 => 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z', // Education
                                    6 => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-7.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' // Health
                                ];
                                $titles = ['บัญชี', 'บุคคล', 'ที่อยู่', 'ครอบครัว', 'การศึกษา', 'สุขภาพ'];
                            @endphp
                            <button wire:click="$set('currentStep', {{ $step }})"
                                class="flex flex-col items-center justify-center p-3 rounded-2xl border transition-all duration-300 {{ $isActive ? ($isCurrent ? 'bg-blue-600 border-blue-600 text-white shadow-lg scale-105' : 'bg-white border-blue-200 text-blue-600') : 'bg-slate-50 border-transparent text-slate-400 hover:bg-slate-100' }}">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        @if($currentStep === 1)
                            <div class="space-y-6 animate-fade-in">
                                <h2 class="text-2xl font-bold text-slate-800 border-l-4 border-blue-500 pl-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {{-- Standard Input Component Inline --}}
                                    <div class="flex flex-col gap-1 group">
                                        <label class="text-sm font-bold text-slate-700 ml-1">Username <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" wire:model.blur="state.username" placeholder="ตั้งชื่อผู้ใช้ระบบ"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.username') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                        @error('state.username') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="flex flex-col gap-1 group">
                                        <label class="text-sm font-bold text-slate-700 ml-1">Password <span
                                                class="text-red-500">*</span></label>
                                        <input type="password" wire:model.blur="state.password"
                                            placeholder="รหัสผ่านอย่างน้อย 6 ตัวอักษร"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.password') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                        @error('state.password') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>
                                    ...
                                    <div class="flex flex-col gap-1 group">
                                        ...
                                        <input type="text" wire:model.blur="state.student_id" placeholder="เช่น 66101"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.student_id') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                        @error('state.student_id') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="flex flex-col gap-1 group">
                                        <label class="text-sm font-bold text-slate-700 ml-1">เลขบัตรประชาชน <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" wire:model.blur="state.id_card_number" placeholder="13 หลัก"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.id_card_number') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                        @error('state.id_card_number') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="flex flex-col gap-1 group">
                                        <label class="text-sm font-bold text-slate-700 ml-1">เพศ <span
                                                class="text-red-500">*</span></label>
                                        <select wire:model.blur="state.gender"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none appearance-none bg-white @error('state.gender') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                            <option value="">เลือกเพศ...</option>
                                            <option value="Male">ชาย</option>
                                            <option value="Female">หญิง</option>
                                        </select>
                                        @error('state.gender') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>
                        ...
                        @if($currentStep === 2)
                            <div class="space-y-6 animate-fade-in">
                                <h2 class="text-2xl font-bold text-slate-800 border-l-4 border-blue-500 pl-4">ข้อมูลส่วนตัว
                                </h2>

                                <div class="bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                                    <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider mb-4">ชื่อภาษาไทย
                                    </h3>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div class="flex flex-col gap-1 group">
                                            <label class="text-sm font-bold text-slate-700 ml-1">ชื่อจริง</label>
                                            <input type="text" wire:model.blur="state.first_name_th"
                                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none">
                                        </div>
                                        <div class="flex flex-col gap-1 group">
                                            <label class="text-sm font-bold text-slate-700 ml-1">นามสกุล</label>
                        ...
                        @if($currentStep === 3)
                            <div class="space-y-6 animate-fade-in">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="flex flex-col gap-1 group">
                                        <label class="text-sm font-bold text-slate-700 ml-1">เบอร์โทรศัพท์ <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" wire:model.blur="state.phone"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.phone') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                        @error('state.phone') <span
                                        class="text-xs text-red-500 font-bold ml-1">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="flex flex-col gap-1 group">
                                        ...
                                        <input type="email" wire:model.blur="state.email"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none @error('state.email') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea wire:model.blur="state.current_address" rows="3"
                                        class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none resize-none"></textarea>
                                </div>
                        ...
                        @if($currentStep === 4)
                            <div class="space-y-6 animate-fade-in">
                                <h2 class="text-2xl font-bold text-slate-800 border-l-4 border-blue-500 pl-4">ข้อมูลครอบครัว
                                </h2>
                            ...
                            <div class="space-y-6 animate-fade-in">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex flex-col gap-1 group md:col-span-2">
                                        <label class="text-sm font-bold text-slate-700 ml-1">หลักสูตร <span
                                                class="text-red-500">*</span></label>
                                        <select wire:model.blur="state.course_id"
                                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none appearance-none bg-white">
                        ...
                        @if($currentStep === 6)
                            <div class="space-y-6 animate-fade-in">
                                <h2 class="text-2xl font-bold text-slate-800 border-l-4 border-blue-500 pl-4">ข้อมูลสุขภาพ
                                </h2>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea wire:model.blur="state.chronic_diseases" rows="2"
                                        class="w-full px-4 py-3 rounded-xl border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none resize-none"></textarea>
                                </div>
                                <div class="space-y-2">
                            ...
                            <div class="flex gap-4">
                                @if($currentStep < $totalSteps)
                                    <button type="button" wire:click="nextStep"
                                        class="px-8 py-3 rounded-xl bg-blue-600 text-white font-bold shadow-lg shadow-blue-500/30 hover:bg-blue-700 transition-all hover:scale-105 active:scale-95">
                                        ถัดไป
                                    </button>
                                @else
                                    <button type="submit"
        ...
        {{-- Include UX enhancements if available, wrapped safely --}}
        @if(view()->exists('components.partials.registration-ux-enhancements'))
            @include('components.partials.registration-ux-enhancements')
        @endif
        ...
        <script>
            document.addEventListener('livewire:initialized', () => {
                @this.on('registration-success', () => {
                    Swal.fire({
                        title: 'สำเร็จ!',
                        text: 'ลงทะเบียนนักเรียนใหม่เรียบร้อยแล้ว',
                        icon: 'success',

...
<div class="min-h-screen flex bg-surface-hover">
    ...
    <main class="flex-1 lg:ml-72 p-8 md:p-12 overflow-y-auto">
        <header class="mb-10 text-center md:text-left">
            <h1 class="text-3xl font-bold text-text tracking-tight">ระบบประเมินผล</h1>
            <p class="text-text-muted font-medium mt-1">ประเมินอาจารย์ผู้สอน และเพื่อนร่วมห้องเพื่อการพัฒนาที่ดียิ่งขึ้น
            </p>
        </header>
            ...
            @if($peerEvaluationEnabled)
                <section class="space-y-6">
                    <div class="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-text tracking-tight">ประเมินเพื่อนร่วมรุ่น</h2>
                            <p class="text-text-disabled text-sm font-medium">ประเมินพฤติกรรมและการมีส่วนร่วม</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        @forelse($classmates as $mate)
                            <div
                                class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-border flex justify-between items-center group hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-1 transition-all relative overflow-hidden">
                                <!-- Background Decoration -->
                                <div
                                ...
                                <div class="flex items-center gap-4 z-10">
                                    <div
                                        class="w-12 h-12 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 font-bold text-lg shadow-inner">
                                        {{ mb_substr($mate->first_name_th, 0, 1) }}
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-bold text-text leading-tight">{{ $mate->first_name_th }}
                                ...
                                <div class="z-10">
                                    @if(in_array($mate->id, $evaluatedPeers))
                                        <span
                                            class="px-4 py-2 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded-lg border border-emerald-100 uppercase flex items-center gap-1">
                        ...
                        @empty
                            <div class="bg-white p-12 rounded-[2.5rem] text-center border border-dashed border-border">
                                <div
                                    class="w-16 h-16 bg-surface-hover rounded-2xl flex items-center justify-center text-text-disabled mx-auto mb-4">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                                        </path>
                                ...
                                <p class="text-text-disabled font-bold">ไม่พบรายชื่อเพื่อนในรุ่นเดียวกัน</p>
                            </div>
                        @endforelse
                    </div>
                </section>
            @else
                <section class="space-y-6">
                    <div class="flex items-center gap-4 mb-2 opacity-50">
                        <div class="w-12 h-12 bg-surface-hover rounded-2xl flex items-center justify-center text-text-disabled">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                                </path>
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-text-disabled tracking-tight">ประเมินเพื่อนร่วมรุ่น</h2>
                            <p class="text-text-disabled text-sm font-medium">ยังไม่เปิดให้ใช้งาน</p>
                        </div>
                    </div>
                    <div
                        class="bg-surface-hover p-12 rounded-[2.5rem] text-center border-2 border-dashed border-border flex flex-col items-center justify-center h-64">
                        ...
                        <p class="text-text-muted font-bold text-lg">Coming Soon</p>
                        <p class="text-text-disabled text-sm mt-1">ระบบประเมินเพื่อนร่วมรุ่นยังไม่เปิดให้ใช้งานในขณะนี้</p>
                    </div>
                </section>
            @endif
        </div>
